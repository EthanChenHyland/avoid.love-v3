      ...
      media.add(
        ...
        (match) => {
          ...
          gsap.timeline({
            ...
            .to(".fine-copy--before", { y: mobile ? -54 : -92, opacity: 0, duration: 0.12, ease: "none" }, 0.16)
            .fromTo(".fine-copy--them", { y: mobile ? 58 : 96, opacity: 0 }, { y: 0, opacity: 1, duration: 0.16, ease: "none" }, 0.31)
          ...
          gsap.timeline({
            ...
            .fromTo(".them-copy", { y: mobile ? 18 : 34, opacity: 0.78 }, { y: 0, opacity: 1, ease: "none" }, 0.05)
            .fromTo(".notice-points button", { x: 18, opacity: 0.72 }, { x: 0, opacity: 1, stagger: 0.1, ease: "none" }, 0.38);

          gsap.timeline({
            scrollTrigger: { trigger: ".scene--little", start: "top 75%", end: "74% 30%", scrub: 0.9 },
          })
            .fromTo(".little-heading", { y: 28, opacity: 0.78 }, { y: 0, opacity: 1, ease: "none" }, 0)
          ...
          gsap.timeline({
            ...
            .fromTo(".waiting-copy", { y: 20, opacity: 0.78 }, { y: 0, opacity: 1, ease: "none" }, 0.02)
            .fromTo(".phone-check", { y: mobile ? 20 : 38, opacity: 0.72, rotate: 2 }, { y: 0, opacity: 1, rotate: -1, ease: "none" }, mobile ? 0.28 : 0.38)
            .fromTo(".waiting-aside", { opacity: 0.72 }, { opacity: 0.94, ease: "none" }, 0.62);

          gsap.timeline({
            scrollTrigger: { trigger: ".scene--almost", start: "top 84%", end: "bottom 18%", scrub: 0.9 },
          })
            .fromTo(".almost-copy", { y: mobile ? 28 : 42, opacity: 0.78 }, { y: 0, opacity: 1, ease: "none" }, 0)
            .fromTo(".almost-note", { y: mobile ? 24 : 32, rotate: 7, scale: 0.94, opacity: 0.78 }, { y: 0, rotate: -2, scale: 1, opacity: 1, ease: "none" }, 0.08)
            .fromTo(".almost-result", { y: 10 }, { y: 0, ease: "none" }, 0.16);

          gsap.timeline({
            scrollTrigger: { trigger: ".scene--unsent", start: "top 80%", end: "bottom 18%", scrub: 0.95 },
          })
            .fromTo(".unsent-copy", { x: mobile ? -20 : -42, opacity: 0.78 }, { x: 0, opacity: 1, ease: "none" }, 0)
            .fromTo(".draft-paper", { x: mobile ? "24vw" : "16vw", y: 46, rotate: 8, opacity: 0.78 }, { x: 0, y: 0, rotate: -2, opacity: 1, ease: "none" }, 0.1)
            .fromTo(".unsent-result", { y: 12, opacity: 0.86 }, { y: 0, opacity: 1, ease: "none" }, 0.48);
          ...
          memoryTimeline
            ...
            .to(".memories-copy", { y: 0, opacity: 1, ease: "none" }, 0.2)
            ...
            .fromTo(".memories-footnote", { opacity: 0.78, y: 12 }, { opacity: 1, y: 0, duration: 0.18, ease: "none" }, 0.48)
            .to(".memories-copy", { y: mobile ? -58 : -82, opacity: 0, duration: 0.08, ease: "none" }, 0.66)
            ...
            .fromTo(".memory-collapse > p", { opacity: 0, y: 20 }, { opacity: 1, y: 0, duration: 0.18, ease: "none" }, 1.12)
            .to(".memories-footnote", { opacity: 0, y: -14, duration: 0.1, ease: "none" }, 1.04);
          ...
          gsap.timeline({
            ...
            .to(".distance-copy", { x: 0, opacity: 1, ease: "none" }, 0.25)
            .fromTo(".distance-pull", { opacity: 0.74, y: 24 }, { opacity: 1, y: 0, ease: "none" }, 0.36)
            .fromTo(".distance-check", { opacity: 0.74, y: 18 }, { opacity: 1, y: 0, ease: "none" }, 0.58);

          gsap.timeline({
            scrollTrigger: { trigger: ".scene--trying", start: "top 78%", end: "76% 28%", scrub: 0.9 },
          })
            .fromTo(".trying-copy", { y: 30, opacity: 0.78 }, { y: 0, opacity: 1, ease: "none" }, 0)
            ...
            .fromTo(".trying-answer", { opacity: 0.74 }, { opacity: 1, ease: "none" }, 0.56)
            .to(".loss-object > span, .loss-object > strong, .trying-answer", { opacity: 1, y: 0, ease: "none" }, 0.84);

          const returnPieces = [
            { name: "flower", x: mobile ? "-58vw" : "24vw", y: "18vh", rotate: -24, scale: 0.62, settle: -7 },
            { name: "photo", x: mobile ? "46vw" : "38vw", y: "24vh", rotate: 17, scale: 0.72, settle: 5 },
            { name: "message", x: mobile ? "-40vw" : "-34vw", y: "22vh", rotate: -12, scale: 0.78, settle: -2 },
            { name: "ticket", x: mobile ? "44vw" : "34vw", y: "-18vh", rotate: 14, scale: 0.7, settle: 4 },
            { name: "note", x: mobile ? "40vw" : "32vw", y: "26vh", rotate: 12, scale: 0.74, settle: 3 },
          ] as const;
          ...
          returnTimeline
            ...
            .fromTo(".nothing-vignette", { opacity: 0.42 }, { opacity: 1, ease: "none" }, 0)
            .fromTo(".memory-storm", { opacity: 0, scale: 0.94, rotate: -1.4 }, { opacity: 1, scale: 1.04, rotate: 0.8, ease: "none" }, 0.08)
            .fromTo(".nothing-word", { scale: 0.6, rotate: -9, opacity: 0, filter: "blur(12px)" }, { scale: 1.12, rotate: 2, opacity: 0.16, filter: "blur(0px)", ease: "none" }, 0.04)
            .fromTo(".nothing-copy > *", { y: mobile ? 18 : 26, opacity: 0.66 }, { y: 0, opacity: 1, stagger: 0.07, ease: "none" }, 0.08)
            .fromTo(".nothing-thread i", { scaleX: 0, opacity: 0.35 }, { scaleX: 1, opacity: 1, ease: "none" }, 0.14)
            .fromTo(".return-cloud", { scale: 0.94, rotate: -1, opacity: 0.84 }, { scale: 1, rotate: 0.7, opacity: 1, ease: "none" }, 0.18);
          returnPieces.forEach((piece, index) => {
            returnTimeline.fromTo(
              ...
              { opacity: 1, x: 0, y: 0, rotate: piece.settle, scale: 1, ease: "none" },
              0.22 + index * 0.075,
            );
          });
          returnTimeline
            .to(".return-piece--flower, .return-piece--photo", { y: mobile ? -8 : -14, ease: "none" }, 0.72)
            .to(".return-piece--message, .return-piece--note", { y: mobile ? 7 : 11, ease: "none" }, 0.75)
            .to(".return-piece--ticket", { x: mobile ? -5 : -10, rotate: 1, ease: "none" }, 0.78)
            .to(".return-cloud", { rotate: -0.45, scale: 1.015, ease: "none" }, 0.76)
            .to(".nothing-word", { xPercent: -4, yPercent: 2, rotate: -1, ease: "none" }, 0.74)
            .to(".memory-storm", { rotate: -0.6, scale: 1, ease: "none" }, 0.76);
          ...
          gsap.timeline({
            ...
            .fromTo(".love-copy > *", { y: 18, opacity: 0.78 }, { y: 0, opacity: 1, stagger: 0.11, ease: "none" }, 0.08)
            .fromTo(".final-letter", { y: mobile ? 50 : 86, x: mobile ? 0 : 62, rotate: 6, scale: 0.9, opacity: 0.78 }, { y: 0, x: 0, rotate: -2, scale: 1, opacity: 1, ease: "none" }, 0.27);
        },
      );
